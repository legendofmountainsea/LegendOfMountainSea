	...
	HOUYI: {
		...
		DATA: {
			...
			STAND: {
				NAME: 'houyi_stand',
				SPEED: 0.025,
				PATH: './assets/characters/HouYi/houyi_stand/houyi_stand.json',
			},
			WALK: {
				NAME: 'houyi_walk',
				SPEED: 0.08,
				PATH: './assets/characters/HouYi/houyi_walk/houyi_walk.json',
			},
			ATTACK: {
				NAME: 'houyi_attack',
				SPEED: 0.25,
			...
			ULTIMATE: {
				NAME: 'houyi_ultimate',
				SPEED: 0.25,
				PATH: './assets/characters/HouYi/houyi_ultimate/houyi_ultimate.json',
			},
			BATTLE: {
				NAME: 'houyi_battle',
				SPEED: 0.025,
